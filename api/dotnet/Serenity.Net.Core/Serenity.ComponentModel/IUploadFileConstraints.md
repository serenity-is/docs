...
| name | description |
| --- | --- |
| [AllowedExtensions](IUploadFileConstraints/AllowedExtensions.md) { get; } | Semicolon-separated list of allowed file extensions, like ".xlsx;.docx;.jpg" etc. If specified, only allow files with these extensions. This is currently only used by the upload behavior, the editor and temporary upload do not yet use this setting. |
...
* **Source:** *[IUploadFileConstraints.cs](https://github.com/serenity-is/Serenity/blob/master/src/Core/ComponentModel/Upload/IUploadFileConstraints.cs)*