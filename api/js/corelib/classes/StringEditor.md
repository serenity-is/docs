...
Defined in: [src/ui/editors/stringeditor.tsx:9](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/stringeditor.tsx#L9)
...
> **new StringEditor**\<`P`\>(`props`): `StringEditor`\<`P`\>
