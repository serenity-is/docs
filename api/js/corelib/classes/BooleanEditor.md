...
- [getCustomAttribute](BooleanEditor.md#getcustomattribute)
- [getFieldElement](BooleanEditor.md#getfieldelement)
- [getGridField](BooleanEditor.md#getgridfield)
- [get\_value](BooleanEditor.md#get_value)
- [init](BooleanEditor.md#init)
- [internalInit](BooleanEditor.md#internalinit)
- [internalRenderContents](BooleanEditor.md#internalrendercontents)
- [render](BooleanEditor.md#render)
- [renderContents](BooleanEditor.md#rendercontents)
- [set\_value](BooleanEditor.md#set_value)
- [syncOrAsyncThen](BooleanEditor.md#syncorasyncthen)
- [useIdPrefix](BooleanEditor.md#useidprefix)
- [create](BooleanEditor.md#create)
- [createDefaultElement](BooleanEditor.md#createdefaultelement)
...
• **new BooleanEditor**\<`P`\>(`props`): [`BooleanEditor`](BooleanEditor.md)\<`P`\>
...
[`BooleanEditor`](BooleanEditor.md)\<`P`\>
...
[src/ui/editors/booleaneditor.ts:11](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/booleaneditor.ts#L11)
...
[src/ui/editors/booleaneditor.ts:25](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/booleaneditor.ts#L25)
