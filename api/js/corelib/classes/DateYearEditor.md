...
Defined in: [src/ui/editors/dateyeareditor.ts:9](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/dateyeareditor.ts#L9)
...
Defined in: [src/ui/editors/dateyeareditor.ts:16](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/dateyeareditor.ts#L16)
...
Defined in: [src/ui/editors/dateyeareditor.ts:10](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/dateyeareditor.ts#L10)
...
[`SelectEditor`](SelectEditor.md).[`getDialogType`](SelectEditor.md#getdialogtype)
...
Defined in: [src/ui/editors/dateyeareditor.ts:26](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/dateyeareditor.ts#L26)
...
[`SelectEditor`](SelectEditor.md).[`registerClass`](SelectEditor.md#registerclass)
...
[`SelectEditor`](SelectEditor.md).[`registerEditor`](SelectEditor.md#registereditor)
