...
Defined in: [src/ui/editors/timeeditor.ts:24](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/timeeditor.ts#L24)
...
- [`TimeSpanEditor`](TimeSpanEditor.md)

## Type Parameters

### P

`P` *extends* [`TimeEditorBaseOptions`](../interfaces/TimeEditorBaseOptions.md)
...
> **new TimeEditorBase**\<`P`\>(`props`): `TimeEditorBase`\<`P`\>

Defined in: [src/ui/editors/timeeditor.ts:39](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/timeeditor.ts#L39)
...
Defined in: [src/ui/editors/timeeditor.ts:25](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/timeeditor.ts#L25)
