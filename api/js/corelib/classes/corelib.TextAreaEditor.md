[@serenity-is](../README.md) / [Modules](../modules.md) / [corelib](../modules/corelib.md) / TextAreaEditor

# Class: TextAreaEditor

[corelib](../modules/corelib.md).TextAreaEditor

## Hierarchy

- [`Widget`](corelib.Widget.md)<[`TextAreaEditorOptions`](../interfaces/corelib.TextAreaEditorOptions.md)\>
...
- [constructor](corelib.TextAreaEditor.md#constructor)

### Properties

- [element](corelib.TextAreaEditor.md#element)
- [idPrefix](corelib.TextAreaEditor.md#idprefix)
- [options](corelib.TextAreaEditor.md#options)
- [uniqueName](corelib.TextAreaEditor.md#uniquename)
- [widgetName](corelib.TextAreaEditor.md#widgetname)

### Accessors

- [value](corelib.TextAreaEditor.md#value)

### Methods

- [addCssClass](corelib.TextAreaEditor.md#addcssclass)
- [addValidationRule](corelib.TextAreaEditor.md#addvalidationrule)
- [change](corelib.TextAreaEditor.md#change)
- [changeSelect2](corelib.TextAreaEditor.md#changeselect2)
- [destroy](corelib.TextAreaEditor.md#destroy)
- [getCssClass](corelib.TextAreaEditor.md#getcssclass)
- [getGridField](corelib.TextAreaEditor.md#getgridfield)
- [get\_value](corelib.TextAreaEditor.md#get_value)
- [init](corelib.TextAreaEditor.md#init)
- [initialize](corelib.TextAreaEditor.md#initialize)
- [renderContents](corelib.TextAreaEditor.md#rendercontents)
- [set\_value](corelib.TextAreaEditor.md#set_value)
- [create](corelib.TextAreaEditor.md#create)
- [elementFor](corelib.TextAreaEditor.md#elementfor)
- [getWidgetName](corelib.TextAreaEditor.md#getwidgetname)
...
| :------ | :------ |
| `input` | `JQuery` |
| `opt?` | [`TextAreaEditorOptions`](../interfaces/corelib.TextAreaEditorOptions.md) |
...
[src/ui/editors/textareaeditor.ts:14](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/textareaeditor.ts#line&#x3D;14)
...
• `Protected` **options**: [`TextAreaEditorOptions`](../interfaces/corelib.TextAreaEditorOptions.md)
...
[src/ui/editors/textareaeditor.ts:25](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/textareaeditor.ts#line&#x3D;25)
...
[src/ui/editors/textareaeditor.ts:33](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/textareaeditor.ts#line&#x3D;33)
...
[src/ui/editors/textareaeditor.ts:29](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/textareaeditor.ts#line&#x3D;29)

___

### init

▸ **init**(`action?`): [`TextAreaEditor`](corelib.TextAreaEditor.md)
...
[src/ui/editors/textareaeditor.ts:37](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/textareaeditor.ts#line&#x3D;37)
