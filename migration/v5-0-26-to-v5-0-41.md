...
Replace following line in appsettings.json
...
## Add Serenity.Pro.EmailClient Explorer Package Reference (If Used)

StartSharp Email IMAP Client is now in its own `Serenity.Pro.DataExplorer` package. It is also referenced by Serenity.Demo.AdvancedSamples if you install it.
