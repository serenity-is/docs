...
| name | description |
| --- | --- |
| [Criteria](Criteria/Criteria.md)(…) | Creates a new criteria with given condition. This condition is usually a field name, but it can also be a criteria text pre-generated. (10 constructors) |
...
| static [Field](Criteria/Field.md) { get; } | Gets a reference to the IField object passed to the constructor. |
...
* **Source:** *[Criteria.cs](https://github.com/serenity-is/Serenity/blob/master/src/Services/Data/Criteria/Criteria.cs)*