[@serenity-is/corelib](../README.md) / FilterOperatorSelect

# Class: FilterOperatorSelect

Defined in: [src/ui/filtering/filterpanel.tsx:66](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L66)

A combobox that lets the user select a filter operator.

## Extends

- [`ComboboxEditor`](ComboboxEditor.md)\<`any`, [`FilterOperator`](../interfaces/FilterOperator.md)\>

## Constructors

### Constructor

> **new FilterOperatorSelect**(`props`): `FilterOperatorSelect`

Defined in: [src/ui/filtering/filterpanel.tsx:73](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L73)
...
[`WidgetProps`](../type-aliases/WidgetProps.md)\<\{ `source`: [`FilterOperator`](../interfaces/FilterOperator.md)[]; \}\>

Widget props including the source operators.
...
Defined in: [src/ui/filtering/filterpanel.tsx:67](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L67)
...
[`ComboboxItem`](../interfaces/ComboboxItem.md)\<[`FilterOperator`](../interfaces/FilterOperator.md)\>
...
> `protected` **asyncSearch**(`query`): `PromiseLike`\<[`ComboboxSearchResult`](../interfaces/ComboboxSearchResult.md)\<[`FilterOperator`](../interfaces/FilterOperator.md)\>\>
...
`PromiseLike`\<[`ComboboxSearchResult`](../interfaces/ComboboxSearchResult.md)\<[`FilterOperator`](../interfaces/FilterOperator.md)\>\>
...
> `protected` **cascadeItems**(`items`): [`FilterOperator`](../interfaces/FilterOperator.md)[]
...
Defined in: [src/ui/filtering/filterpanel.tsx:89](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L89)
...
> `protected` **filterItems**(`items`): [`FilterOperator`](../interfaces/FilterOperator.md)[]
...
> `protected` **get\_items**(): [`ComboboxItem`](../interfaces/ComboboxItem.md)\<[`FilterOperator`](../interfaces/FilterOperator.md)\>[]
...
Defined in: [src/ui/filtering/filterpanel.tsx:97](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L97)
