[@serenity-is/corelib](../README.md) / UIDialogMaximizer

# Class: UIDialogMaximizer

Defined in: [src/ui/dialogs/dialogextensions.ts:67](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/dialogs/dialogextensions.ts#L67)
...
- [`Widget`](Widget.md)\<[`UIDialogMaximizerProps`](../interfaces/UIDialogMaximizerProps.md)\>

## Constructors

### Constructor

> **new UIDialogMaximizer**(`props`): `UIDialogMaximizer`

Defined in: [src/ui/dialogs/dialogextensions.ts:83](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/dialogs/dialogextensions.ts#L83)
...
[`WidgetProps`](../type-aliases/WidgetProps.md)\<[`UIDialogMaximizerProps`](../interfaces/UIDialogMaximizerProps.md)\>

Widget props including the dialog element.
...
> `protected` `readonly` **options**: [`WidgetProps`](../type-aliases/WidgetProps.md)\<[`UIDialogMaximizerProps`](../interfaces/UIDialogMaximizerProps.md)\>
...
Defined in: [src/ui/dialogs/dialogextensions.ts:68](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/dialogs/dialogextensions.ts#L68)
...
> `readonly` `static` **defaults**: [`UIDialogMaximizerProps`](../interfaces/UIDialogMaximizerProps.md)

Defined in: [src/ui/dialogs/dialogextensions.ts:71](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/dialogs/dialogextensions.ts#L71)
...
Defined in: [src/ui/dialogs/dialogextensions.ts:121](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/dialogs/dialogextensions.ts#L121)
...
True when the dialog is maximized.
...
Defined in: [src/ui/dialogs/dialogextensions.ts:137](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/dialogs/dialogextensions.ts#L137)
...
Defined in: [src/ui/dialogs/dialogextensions.ts:164](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/dialogs/dialogextensions.ts#L164)
