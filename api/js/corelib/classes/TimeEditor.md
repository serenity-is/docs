[@serenity-is/corelib](../README.md) / [Exports](../modules.md) / TimeEditor

# Class: TimeEditor

## Hierarchy

- [`Widget`](Widget.md)<[`TimeEditorOptions`](../interfaces/TimeEditorOptions.md)\>
...
- [widgetName](TimeEditor.md#widgetname)
...
- [initialize](TimeEditor.md#initialize)
...
- [elementFor](TimeEditor.md#elementfor)
...
| :------ | :------ |
| `input` | `JQuery` |
| `opt?` | [`TimeEditorOptions`](../interfaces/TimeEditorOptions.md) |
...
• `Protected` **options**: [`TimeEditorOptions`](../interfaces/TimeEditorOptions.md)
...
▸ **init**(`action?`): [`TimeEditor`](TimeEditor.md)
