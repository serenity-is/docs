...
| [IsLookup](Field/IsLookup.md) { get; } | Gets if this field is one with a LookupInclude attribute or an ID or Name field. |
...
| [Name](Field/Name.md) { get; } | Gets the column name. |
...
| [AsInvariant](Field/AsInvariant.md)(…) | Sets the value of this field in specified row as object using ConvertValue with InvariantCulture. |
| [AsObject](Field/AsObject.md)(…) | Gets the value of this row as an object. |
| abstract [AsObject](Field/AsObject.md)(…) | Sets the value of this field in specified row as object. |
| abstract [AsObjectNoCheck](Field/AsObjectNoCheck.md)(…) | Gets the value of this field in specified row as object, skipping check for assignment even if TrackWithChecks is true. Use at your own risk! |
...
| [CopyNoAssignment](Field/CopyNoAssignment.md)(…) | Copies the field value without marking the target as assigned. |
...
| [IsNull](Field/IsNull.md)(…) | Determines whether the specified row is null. This method checks for assignment if TrackWithChecks is true and may throw an exception if the field is unassigned. Use IsNullNoCheck to skip that check. |
| abstract [IsNullNoCheck](Field/IsNullNoCheck.md)(…) | Gets if the field value is null without checking for assignment. |
...
| abstract [ValueFromJson](Field/ValueFromJson.md)(…) | Deserializes this field's value from JSON. (2 methods) |
| abstract [ValueToJson](Field/ValueToJson.md)(…) | Serializes this field's value to JSON. (2 methods) |
