...
At the top of the left sidebar, there is a dropdown menu with a user icon with which we can change our password or log out, in addition to a language button to change the active language.
