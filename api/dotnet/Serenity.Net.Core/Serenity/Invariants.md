...
| static [IsIntegerType](Invariants/IsIntegerType.md)(…) | Determines whether the type of the value is an integer type (Int16, Int32, Int64). Avoid using this function as it is obsolete. |
