[serenity-is/corelib](../README.md) / localText

# Function: localText()

> **localText**(`key`, `defaultText?`): `string`

Defined in: [src/base/localtext.ts:46](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/base/localtext.ts#L46)
