[corelib](../README.md) / getColumnsScript

# Function: getColumnsScript()

> **getColumnsScript**(`key`): `Promise`\<[`PropertyItemsData`](../interfaces/PropertyItemsData.md)\>

Defined in: [src/base/scriptdata.ts:207](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/base/scriptdata.ts#L207)
