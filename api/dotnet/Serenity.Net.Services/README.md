...
| signature | name | description |
| --: | --- | --- |
| class  | [AddBehaviorAttribute](Serenity.ComponentModel/AddBehaviorAttribute.md) | Attaches an explicit behavior to a class or property. |
...
| static class  | [AliasedFields](Serenity.Data/AliasedFields.md) | Contains extension methods to create aliased fields. |
| static class  | [AliasExtensions](Serenity.Data/AliasExtensions.md) | Contains extension methods for Alias objects. |
| abstract class  | [BaseCriteria](Serenity.Data/BaseCriteria.md) | The base criteria object type, from which all criteria types derive. |
...
| class  | [BooleanField](Serenity.Data/BooleanField.md) | Field with a boolean value. |
...
| class  | [Criteria](Serenity.Data/Criteria.md) | An object that is used to create criteria by employing the operator overloading features of the C# language, instead of using string based criteria. |
...
| class  | [DefaultSqlConnections](Serenity.Data/DefaultSqlConnections.md) | The default connection factory. |
| class  | [DefaultSqlDialectMapper](Serenity.Data/DefaultSqlDialectMapper.md) | Default implementation of [`ISqlDialectMapper`](Serenity.Data/ISqlDialectMapper.md) that maps well-known provider names and dialect type names to their corresponding [`ISqlDialect`](Serenity.Data/ISqlDialect.md). |
| class  | [DeltaLister&lt;TItem&gt;](Serenity.Data/DeltaLister-1.md) | Helper class to find differences between two lists for updating. |
...
| struct  | [FieldExpressionPair](Serenity.Data/FieldExpressionPair.md) | A pair of a field name and its SQL value expression. |
...
| static class  | [FilterableQueryExtensions](Serenity.Data/FilterableQueryExtensions.md) | Extensions for objects implementing [`IFilterableQuery`](Serenity.Data/IFilterableQuery.md). |
...
| interface  | [IDisplayOrderRow](Serenity.Data/IDisplayOrderRow.md) | Basic interface for rows that have a display order field and provides a default sorting order. |
...
| interface  | [IEditableRow](Serenity.Data/IEditableRow.md) | Methods and properties of a row to support editing in desktop applications, grids, and similar scenarios. |
| interface  | [IEmailRow](Serenity.Data/IEmailRow.md) | An interface that provides access to the email field. |
| interface  | [IEntity](Serenity.Data/IEntity.md) | An interface for entities with a Table property. |
...
| interface  | [IHasActualConnection](Serenity.Data/IHasActualConnection.md) | Interface for types that have an [`ActualConnection`](Serenity.Data/IHasActualConnection/ActualConnection.md) property of type IDbConnection. |
| interface  | [IHasActualTransaction](Serenity.Data/IHasActualTransaction.md) | Interface for types that have an [`ActualTransaction`](Serenity.Data/IHasActualTransaction/ActualTransaction.md) property of type IDbTransaction. |
| interface  | [IHasCommandTimeout](Serenity.Data/IHasCommandTimeout.md) | Interface for types that have a [`CommandTimeout`](Serenity.Data/IHasCommandTimeout/CommandTimeout.md) property that determines the default command timeout for that connection. |
| interface  | [IHasConnectionStateChange](Serenity.Data/IHasConnectionStateChange.md) | Interface for types that have a connection [`StateChange`](Serenity.Data/IHasConnectionStateChange/StateChange.md) event (e.g. a connection). |
| interface  | [IHasCurrentTransaction](Serenity.Data/IHasCurrentTransaction.md) | Interface for types that have a [`CurrentTransaction`](Serenity.Data/IHasCurrentTransaction/CurrentTransaction.md) property of type IDbTransaction. |
| interface  | [IHasDialect](Serenity.Data/IHasDialect.md) | Interface for types that have a [`Dialect`](Serenity.Data/IHasDialect/Dialect.md) property of type [`ISqlDialect`](Serenity.Data/ISqlDialect.md). |
| interface  | [IHasLogger](Serenity.Data/IHasLogger.md) | Interface for types that have a [`Logger`](Serenity.Data/IHasLogger/Logger.md) property. |
| interface  | [IHasOpenedOnce](Serenity.Data/IHasOpenedOnce.md) | Interface for types that have an [`OpenedOnce`](Serenity.Data/IHasOpenedOnce/OpenedOnce.md) property that determines if the connection has been opened at least once. |
| interface  | [IHaveJoins](Serenity.Data/IHaveJoins.md) | Interface for row type that provides a list of its joins. |
| interface  | [IIdRow](Serenity.Data/IIdRow.md) | Basic interface for rows that have an ID field. You should put the [IdProperty] attribute on the corresponding field. |
| interface  | [IInsertDateRow](Serenity.Data/IInsertDateRow.md) | Interface for rows that have an InsertDate field. |
| interface  | [IInsertLogRow](Serenity.Data/IInsertLogRow.md) | Interface for rows that have InsertUserId and InsertDate fields. |
| interface  | [IInsertUserIdRow](Serenity.Data/IInsertUserIdRow.md) | Interface for rows that have an InsertUserId field. |
| interface  | [IIsActiveDeletedRow](Serenity.Data/IIsActiveDeletedRow.md) | Marks an [`IIsActiveRow`](Serenity.Data/IIsActiveRow.md) where -1 is used as the deleted value. |
| interface  | [IIsActiveRow](Serenity.Data/IIsActiveRow.md) | Interface for an entity with an active field. |
...
| interface  | [ILoggingRow](Serenity.Data/ILoggingRow.md) | A combination of [`IUpdateLogRow`](Serenity.Data/IUpdateLogRow.md) and [`IInsertLogRow`](Serenity.Data/IInsertLogRow.md). |
| interface  | [IMustRemoveT0](Serenity.Data/IMustRemoveT0.md) | Obsolete interface. |
| interface  | [INameRow](Serenity.Data/INameRow.md) | Marks a row as having a Name field (e.g. description for the row). You should put the [NameProperty] attribute on the corresponding field. |
...
| interface  | [ISqlDialectMapper](Serenity.Data/ISqlDialectMapper.md) | Maps a dialect or provider name to an [`ISqlDialect`](Serenity.Data/ISqlDialect.md) instance. |
| interface  | [ISqlExpressionTranslator](Serenity.Data/ISqlExpressionTranslator.md) | An interface that custom [`ISqlDialect`](Serenity.Data/ISqlDialect.md) types can implement to change the generated expressions for dynamic expressions like `ConcatExpressionAttribute`. Implementors should return `null` if they cannot handle the given expression type. |
...
| interface  | [ISqlQueryToString](Serenity.Data/ISqlQueryToString.md) | Interface for types that can convert an [`ISqlQuery`](Serenity.Data/ISqlQuery.md) to its string representation. |
| interface  | [IUnitOfWork](Serenity.Data/IUnitOfWork.md) | An interface to implement the unit of work pattern, e.g. a transaction. |
| interface  | [IUpdateDateRow](Serenity.Data/IUpdateDateRow.md) | Interface for rows that have an UpdateDate field. |
| interface  | [IUpdateLogRow](Serenity.Data/IUpdateLogRow.md) | Interface for rows that have UpdateUserId and UpdateDate fields. |
| interface  | [IUpdateUserIdRow](Serenity.Data/IUpdateUserIdRow.md) | Interface for rows that have an UpdateUserId field. |
...
| class  | [JsonCriteriaConverter](Serenity.Data/JsonCriteriaConverter.md) | Serializes and deserializes a [`BaseCriteria`](Serenity.Data/BaseCriteria.md) object. |
| class  | [JsonField&lt;TValue&gt;](Serenity.Data/JsonField-1.md) | Field with a JSON value. |
| class  | [JsonRowConverter](Serenity.Data/JsonRowConverter.md) | Serialize/deserialize a row |
| class  | [JsonSafeCriteriaConverter](Serenity.Data/JsonSafeCriteriaConverter.md) | Serializes and deserializes a [`BaseCriteria`](Serenity.Data/BaseCriteria.md) object and checks for the safety of criteria expressions. |
...
| struct  | [OldNewPair&lt;TItem&gt;](Serenity.Data/OldNewPair-1.md) | A pair of old and new values. |
| class  | [Oracle12cDialect](Serenity.Data/Oracle12cDialect.md) | SQL dialect for Oracle 12c, which uses OFFSET FETCH instead of ROWNUM. |
| class  | [OracleDialect](Serenity.Data/OracleDialect.md) | SQL dialect for Oracle. |
...
| static class  | [ParamPrefixReplacer](Serenity.Data/ParamPrefixReplacer.md) | Replaces the parameter prefix character in SQL expressions. |
| class  | [PostgresDialect](Serenity.Data/PostgresDialect.md) | SQL dialect for Postgres. |
...
| static class  | [QueryWithParamsExtensions](Serenity.Data/QueryWithParamsExtensions.md) | Extension methods for classes implementing [`IQueryWithParams`](Serenity.Data/IQueryWithParams.md). |
...
| static class  | [SetFieldByStatementExtensions](Serenity.Data/SetFieldByStatementExtensions.md) | Extension methods for classes implementing [`ISetFieldByStatement`](Serenity.Data/ISetFieldByStatement.md). |
...
| class  | [SqlCommandDumper](Serenity.Data/SqlCommandDumper.md) | Generates a debug version of a SQL command, including DECLARE statements for its parameters, so that it can be executed or inspected outside of the original connection. Based on the answer by Mitch at http://stackoverflow.com/questions/265192/get-the-generated-sql-statement-from-a-sqlcommand-object. |
...
| static class  | [SqlMapper](Serenity.Data/SqlMapper.md) | Provides IDbConnection extension methods that wrap the corresponding Dapper SqlMapper methods, translating Serenity SQL (dialect specific brackets and parameter prefixes) via [`Translate`](Serenity.Data/SqlConversions/Translate.md) and ensuring the connection is open before execution. It mirrors the string based `Execute` and `Query` extension methods of Dapper's `SqlMapper`, not every Dapper overload (CommandDefinition based methods, ExecuteScalar, ExecuteReader, QueryFirst, QueryMultiple, etc.), as well as their async variants. The [`ISqlQuery`](Serenity.Data/ISqlQuery.md) overloads are Serenity specific and have no Dapper equivalent. Note that unlike [`SqlHelper`](Serenity.Data/SqlHelper.md) methods, these extension methods do not go through [`ISqlOperationInterceptor`](Serenity.Data/ISqlOperationInterceptor.md). |
| class  | [SqlQuery](Serenity.Data/SqlQuery.md) | SQL query string builder that supports SELECT statements with paging, joins, unions, grouping, ordering, and sub queries. |
...
| class  | [TransactionlessUnitOfWork](Serenity.Data/TransactionlessUnitOfWork.md) | A unit of work implementation without an underlying actual transaction. Use with care, only to pass an [`IUnitOfWork`](Serenity.Data/IUnitOfWork.md) instance to some methods where you don't want to actually start a transaction. |
| class  | [TransactionSettings](Serenity.Data/TransactionSettings.md) | Determines the transaction isolation level and defer start flag used for service endpoint actions when creating the [`UnitOfWork`](Serenity.Data/UnitOfWork.md) class. |
| class  | [TransactionSettingsAttribute](Serenity.Data/TransactionSettingsAttribute.md) | Determines the transaction isolation level and defer start flag used for a service endpoint action when creating the [`UnitOfWork`](Serenity.Data/UnitOfWork.md) class. |
...
| class  | [CaseAttribute](Serenity.Data.Mapping/CaseAttribute.md) | Case expression attribute. |
...
| class  | [OuterApplyAttribute](Serenity.Data.Mapping/OuterApplyAttribute.md) | Adds an OUTER APPLY to the row. |
...
| signature | name | description |
| --: | --- | --- |
| class  | [CriteriaJsonConverter](Serenity.JsonConverters/CriteriaJsonConverter.md) | Serializes and deserializes a [`BaseCriteria`](Serenity.Data/BaseCriteria.md) object. |
| class  | [RowJsonConverter](Serenity.JsonConverters/RowJsonConverter.md) | Serialize/deserialize a row |
| class  | [SafeCriteriaJsonConverter](Serenity.JsonConverters/SafeCriteriaJsonConverter.md) | Serializes and deserializes a [`BaseCriteria`](Serenity.Data/BaseCriteria.md) object and checks for the safety of criteria expressions. |
...
| signature | name | description |
| --: | --- | --- |
| static class  | [EntityLocalTexts](Serenity.Localization/EntityLocalTexts.md) | Contains extension methods to register local texts for entity rows. |
...
| interface  | [IReportFactory](Serenity.Reporting/IReportFactory.md) | Abstraction for a report factory that creates a report by its key and populates it with the JSON options passed. |
...
| interface  | [IReportRenderer](Serenity.Reporting/IReportRenderer.md) | Abstraction for a report renderer that renders a report. |
...
| class  | [ReportAttribute](Serenity.Reporting/ReportAttribute.md) | Marks a class as a report. |
...
| class  | [ReportRenderOptions](Serenity.Reporting/ReportRenderOptions.md) | Options used to render a report. |
...
| signature | name | description |
| --: | --- | --- |
| class  | [AsyncToSyncDeleteBehaviorWrapper](Serenity.Services/AsyncToSyncDeleteBehaviorWrapper.md) | Wraps an [`IDeleteBehaviorAsync`](Serenity.Services/IDeleteBehaviorAsync.md) implementation and exposes it as an [`IDeleteBehaviorSync`](Serenity.Services/IDeleteBehaviorSync.md) by blocking on its async methods. This allows synchronous delete request handlers to run asynchronous delete behaviors. |
| class  | [AsyncToSyncListBehaviorWrapper](Serenity.Services/AsyncToSyncListBehaviorWrapper.md) | Wraps an [`IListBehaviorAsync`](Serenity.Services/IListBehaviorAsync.md) implementation and exposes it as an [`IListBehaviorSync`](Serenity.Services/IListBehaviorSync.md) by blocking on its async methods. This allows synchronous list request handlers to run asynchronous list behaviors. |
| class  | [AsyncToSyncRetrieveBehaviorWrapper](Serenity.Services/AsyncToSyncRetrieveBehaviorWrapper.md) | Wraps an [`IRetrieveBehaviorAsync`](Serenity.Services/IRetrieveBehaviorAsync.md) implementation and exposes it as an [`IRetrieveBehaviorSync`](Serenity.Services/IRetrieveBehaviorSync.md) by blocking on its async methods. This allows synchronous retrieve request handlers to run asynchronous retrieve behaviors. |
| class  | [AsyncToSyncSaveBehaviorWrapper](Serenity.Services/AsyncToSyncSaveBehaviorWrapper.md) | Wraps an [`ISaveBehaviorAsync`](Serenity.Services/ISaveBehaviorAsync.md) implementation and exposes it as an [`ISaveBehaviorSync`](Serenity.Services/ISaveBehaviorSync.md) by blocking on its async methods. This allows synchronous save request handlers to run asynchronous save behaviors. |
| class  | [AsyncToSyncUndeleteBehaviorWrapper](Serenity.Services/AsyncToSyncUndeleteBehaviorWrapper.md) | Wraps an [`IUndeleteBehaviorAsync`](Serenity.Services/IUndeleteBehaviorAsync.md) implementation and exposes it as an [`IUndeleteBehaviorSync`](Serenity.Services/IUndeleteBehaviorSync.md) by blocking on its async methods. This allows synchronous undelete request handlers to run asynchronous undelete behaviors. |
| abstract class  | [BaseDeleteBehavior](Serenity.Services/BaseDeleteBehavior.md) | Base class for types implementing [`IDeleteBehaviorSync`](Serenity.Services/IDeleteBehaviorSync.md) |
| abstract class  | [BaseDeleteBehaviorAsync](Serenity.Services/BaseDeleteBehaviorAsync.md) | Base class for types implementing [`IDeleteBehaviorAsync`](Serenity.Services/IDeleteBehaviorAsync.md) |
| abstract class  | [BaseListBehavior](Serenity.Services/BaseListBehavior.md) | Base class for behaviors implementing [`IListBehaviorSync`](Serenity.Services/IListBehaviorSync.md) |
| abstract class  | [BaseListBehaviorAsync](Serenity.Services/BaseListBehaviorAsync.md) | Base class for behaviors implementing [`IListBehaviorAsync`](Serenity.Services/IListBehaviorAsync.md) |
| class  | [BaseRepository](Serenity.Services/BaseRepository.md) | A base class that can be used for repositories (obsolete, [`BaseRequestHandler`](Serenity.Services/BaseRequestHandler.md)) that accept a [`IRequestContext`](Serenity.Services/IRequestContext.md) instance. |
...
| abstract class  | [BaseRetrieveBehavior](Serenity.Services/BaseRetrieveBehavior.md) | Base class for behaviors implementing [`IRetrieveBehaviorSync`](Serenity.Services/IRetrieveBehaviorSync.md) |
| abstract class  | [BaseRetrieveBehaviorAsync](Serenity.Services/BaseRetrieveBehaviorAsync.md) | Base class for behaviors implementing [`IRetrieveBehaviorAsync`](Serenity.Services/IRetrieveBehaviorAsync.md) |
| abstract class  | [BaseSaveBehavior](Serenity.Services/BaseSaveBehavior.md) | Base class for behaviors implementing [`ISaveBehaviorSync`](Serenity.Services/ISaveBehaviorSync.md) |
| abstract class  | [BaseSaveBehaviorAsync](Serenity.Services/BaseSaveBehaviorAsync.md) | Base class for behaviors implementing [`ISaveBehaviorAsync`](Serenity.Services/ISaveBehaviorAsync.md) |
...
| abstract class  | [BaseSaveDeleteBehaviorAsync](Serenity.Services/BaseSaveDeleteBehaviorAsync.md) | Base class for behaviors implementing save and delete async behavior interfaces |
| abstract class  | [BaseUndeleteBehavior](Serenity.Services/BaseUndeleteBehavior.md) | Base class for types implementing [`IUndeleteBehaviorSync`](Serenity.Services/IUndeleteBehaviorSync.md) |
| abstract class  | [BaseUndeleteBehaviorAsync](Serenity.Services/BaseUndeleteBehaviorAsync.md) | Base class for types implementing [`IUndeleteBehaviorAsync`](Serenity.Services/IUndeleteBehaviorAsync.md) |
...
| class  | [CompanionHandlerTypeAttribute](Serenity.Services/CompanionHandlerTypeAttribute.md) | Specifies the companion (other mode) handler interface for a request processor interface, e.g. [`ISaveRequestProcessorAsync`](Serenity.Services/ISaveRequestProcessorAsync.md) as companion of [`ISaveRequestProcessor`](Serenity.Services/ISaveRequestProcessor.md), together with a wrapper type that adapts a custom handler of the companion interface to this interface. |
...
| class  | [DefaultHandlerAttribute](Serenity.Services/DefaultHandlerAttribute.md) | Specifies that the class this attribute is attached to is the default handler (list, create, delete, update etc.) and should be used by some behaviors like MasterDetailRelationBehavior instead of creating a generic handler. |
...
| class  | [DefaultHandlerRegistry](Serenity.Services/DefaultHandlerRegistry.md) | Default implementation for the [`IDefaultHandlerRegistry`](Serenity.Services/IDefaultHandlerRegistry.md). |
...
| class  | [DeleteRequestHandlerAsync&lt;TRow&gt;](Serenity.Services/DeleteRequestHandlerAsync-1.md) | Base generic class for async delete request handlers that use [`DeleteRequest`](Serenity.Services/DeleteRequest.md) as the request type, and [`DeleteResponse`](Serenity.Services/DeleteResponse.md) as the response type. |
| class  | [DeleteRequestHandlerAsync&lt;TRow,TDeleteRequest,TDeleteResponse&gt;](Serenity.Services/DeleteRequestHandlerAsync-3.md) | Generic base class for asynchronous delete request handlers |
| abstract class  | [DeleteRequestHandlerBase&lt;TRow,TDeleteRequest,TDeleteResponse&gt;](Serenity.Services/DeleteRequestHandlerBase-3.md) | Abstract base class for delete request handlers that share state and mode neutral helper methods between synchronous and asynchronous delete request handlers. |
...
| interface  | [ICreateHandlerAsync&lt;TRow&gt;](Serenity.Services/ICreateHandlerAsync-1.md) | Interface for async create request handlers that use [`SaveRequest`](Serenity.Services/SaveRequest-1.md) as the request type, and [`SaveResponse`](Serenity.Services/SaveResponse.md) as the response type. |
| interface  | [ICreateHandlerAsync&lt;TRow,TSaveRequest,TSaveResponse&gt;](Serenity.Services/ICreateHandlerAsync-3.md) | Abstraction for create request handlers with an async Create method. |
| interface  | [IDefaultHandlerFactory](Serenity.Services/IDefaultHandlerFactory.md) | Interface to get a new instance of a default request handler, given its row type and the handler interface. |
...
| interface  | [IDeleteBehavior](Serenity.Services/IDeleteBehavior.md) | Marker interface for delete behaviors that can be used as a mixin within a DeleteRequestHandler lifecycle. |
| interface  | [IDeleteBehaviorAsync](Serenity.Services/IDeleteBehaviorAsync.md) | An asynchronous delete behavior that can be used as a mixin within a DeleteRequestHandlerAsync lifecycle |
| interface  | [IDeleteBehaviorSync](Serenity.Services/IDeleteBehaviorSync.md) | A synchronous delete behavior that can be used as a mixin within a DeleteRequestHandler lifecycle |
...
| interface  | [IDeleteHandlerAsync&lt;TRow&gt;](Serenity.Services/IDeleteHandlerAsync-1.md) | Interface for async delete request handlers that use [`DeleteRequest`](Serenity.Services/DeleteRequest.md) as request, and [`DeleteResponse`](Serenity.Services/DeleteResponse.md) as response types. |
| interface  | [IDeleteHandlerAsync&lt;TRow,TDeleteRequest,TDeleteResponse&gt;](Serenity.Services/IDeleteHandlerAsync-3.md) | Interface for async delete request handlers with custom delete request / response types. |
...
| interface  | [IDeleteRequestProcessorAsync](Serenity.Services/IDeleteRequestProcessorAsync.md) | Abstraction for delete request handlers with an async Process method. |
...
| interface  | [IHandlerActivator](Serenity.Services/IHandlerActivator.md) | Abstraction for request handler activator, that is used to create instances of a handler type. |
...
| interface  | [IListBehavior](Serenity.Services/IListBehavior.md) | Marker interface for list behaviors that can be used as a mixin within a ListRequestHandler lifecycle. |
| interface  | [IListBehaviorAsync](Serenity.Services/IListBehaviorAsync.md) | An asynchronous list behavior that can be used as a mixin within a ListRequestHandlerAsync lifecycle |
| interface  | [IListBehaviorSync](Serenity.Services/IListBehaviorSync.md) | A synchronous list behavior that can be used as a mixin within a ListRequestHandler lifecycle |
...
| interface  | [IListHandlerAsync&lt;TRow&gt;](Serenity.Services/IListHandlerAsync-1.md) | Interface for async list request handlers that use [`ListRequest`](Serenity.Services/ListRequest.md) as request, and [`ListResponse`](Serenity.Services/ListResponse-1.md) as response types. |
| interface  | [IListHandlerAsync&lt;TRow,TListRequest&gt;](Serenity.Services/IListHandlerAsync-2.md) | Interface for async list request handlers with a custom list request type. |
| interface  | [IListHandlerAsync&lt;TRow,TListRequest,TListResponse&gt;](Serenity.Services/IListHandlerAsync-3.md) | Interface for async list request handlers with custom list request / response types. |
...
| interface  | [IListRequestProcessorAsync](Serenity.Services/IListRequestProcessorAsync.md) | Abstraction for list request handlers with an async Process method. |
...
| interface  | [IRetrieveBehavior](Serenity.Services/IRetrieveBehavior.md) | Marker interface for retrieve behaviors that can be used as a mixin within a RetrieveRequestHandler lifecycle. |
| interface  | [IRetrieveBehaviorAsync](Serenity.Services/IRetrieveBehaviorAsync.md) | An asynchronous retrieve behavior that can be used as a mixin within a RetrieveRequestHandlerAsync lifecycle |
| interface  | [IRetrieveBehaviorSync](Serenity.Services/IRetrieveBehaviorSync.md) | A synchronous retrieve behavior that can be used as a mixin within a RetrieveRequestHandler lifecycle |
...
| interface  | [IRetrieveHandler&lt;TRow&gt;](Serenity.Services/IRetrieveHandler-1.md) | Interface for retrieve request handlers. |
...
| interface  | [IRetrieveHandlerAsync&lt;TRow&gt;](Serenity.Services/IRetrieveHandlerAsync-1.md) | Interface for async retrieve request handlers that use [`RetrieveRequest`](Serenity.Services/RetrieveRequest.md) as request, and [`RetrieveResponse`](Serenity.Services/RetrieveResponse-1.md) as response types. |
| interface  | [IRetrieveHandlerAsync&lt;TRow,TRetrieveRequest,TRetrieveResponse&gt;](Serenity.Services/IRetrieveHandlerAsync-3.md) | Interface for async retrieve request handlers with custom retrieve request / response types. |
...
| interface  | [IRetrieveRequestProcessorAsync](Serenity.Services/IRetrieveRequestProcessorAsync.md) | Abstraction for retrieve request handlers with an async Process method. |
...
| interface  | [ISaveBehavior](Serenity.Services/ISaveBehavior.md) | Marker interface for save behaviors that can be used as a mixin within a SaveRequestHandler lifecycle. |
| interface  | [ISaveBehaviorAsync](Serenity.Services/ISaveBehaviorAsync.md) | An asynchronous save behavior that can be used as a mixin within a SaveRequestHandlerAsync lifecycle |
| interface  | [ISaveBehaviorSync](Serenity.Services/ISaveBehaviorSync.md) | A synchronous save behavior that can be used as a mixin within a SaveRequestHandler lifecycle |
...
| interface  | [ISaveHandlerAsync&lt;TRow&gt;](Serenity.Services/ISaveHandlerAsync-1.md) | Interface for async save request handlers that use [`SaveRequest`](Serenity.Services/SaveRequest-1.md) as the request type, and [`SaveResponse`](Serenity.Services/SaveResponse.md) as the response type. |
| interface  | [ISaveHandlerAsync&lt;TRow,TSaveRequest,TSaveResponse&gt;](Serenity.Services/ISaveHandlerAsync-3.md) | Interface for async save request handlers with custom request / response types. |
...
| interface  | [ISaveRequestProcessorAsync](Serenity.Services/ISaveRequestProcessorAsync.md) | Abstraction for save request handlers with an async Process method. |
| interface  | [IUndeleteBehavior](Serenity.Services/IUndeleteBehavior.md) | Marker interface for undelete behaviors that can be used as a mixin within a UndeleteRequestHandler lifecycle. |
| interface  | [IUndeleteBehaviorAsync](Serenity.Services/IUndeleteBehaviorAsync.md) | An asynchronous undelete behavior that can be used as a mixin within a UndeleteRequestHandlerAsync lifecycle |
| interface  | [IUndeleteBehaviorSync](Serenity.Services/IUndeleteBehaviorSync.md) | A synchronous undelete behavior that can be used as a mixin within a UndeleteRequestHandler lifecycle |
...
| interface  | [IUndeleteHandlerAsync&lt;TRow&gt;](Serenity.Services/IUndeleteHandlerAsync-1.md) | Interface for async undelete request handlers that use [`UndeleteRequest`](Serenity.Services/UndeleteRequest.md) as request, and [`UndeleteResponse`](Serenity.Services/UndeleteResponse.md) as response types. |
| interface  | [IUndeleteHandlerAsync&lt;TRow,TUndeleteRequest,TUndeleteResponse&gt;](Serenity.Services/IUndeleteHandlerAsync-3.md) | Interface for async undelete request handlers with custom undelete request / response types. |
...
| interface  | [IUndeleteRequestProcessorAsync](Serenity.Services/IUndeleteRequestProcessorAsync.md) | Abstraction for undelete request handlers with an async Process method. |
...
| interface  | [IUpdateHandlerAsync&lt;TRow&gt;](Serenity.Services/IUpdateHandlerAsync-1.md) | Interface for async update request handlers that use [`SaveRequest`](Serenity.Services/SaveRequest-1.md) as the request type, and [`SaveResponse`](Serenity.Services/SaveResponse.md) as the response type. |
| interface  | [IUpdateHandlerAsync&lt;TRow,TSaveRequest,TSaveResponse&gt;](Serenity.Services/IUpdateHandlerAsync-3.md) | Abstraction for update request handlers with an async Update method. |
| interface  | [IWrappedBehavior](Serenity.Services/IWrappedBehavior.md) | Interface for behaviors that wrap another behavior to adapt it between synchronous and asynchronous variants. Exposes the inner behavior so framework code can check whether it implements additional interfaces (e.g. [`ISaveExceptionBehavior`](Serenity.Services/ISaveExceptionBehavior.md)). |
...
| class  | [ListRequestHandlerAsync&lt;TRow&gt;](Serenity.Services/ListRequestHandlerAsync-1.md) | Base generic class for async list request handlers that use [`ListRequest`](Serenity.Services/ListRequest.md) as the request type, and [`ListResponse`](Serenity.Services/ListResponse-1.md) as the response type. |
| class  | [ListRequestHandlerAsync&lt;TRow,TListRequest,TListResponse&gt;](Serenity.Services/ListRequestHandlerAsync-3.md) | Generic base class for asynchronous list request handlers |
| abstract class  | [ListRequestHandlerBase&lt;TRow,TListRequest,TListResponse&gt;](Serenity.Services/ListRequestHandlerBase-3.md) | Abstract base class for list request handlers that share state and mode neutral helper methods between synchronous and asynchronous list request handlers. |
...
| class  | [RetrieveRequestHandlerAsync&lt;TRow&gt;](Serenity.Services/RetrieveRequestHandlerAsync-1.md) | Base generic class for async retrieve request handlers that use [`RetrieveRequest`](Serenity.Services/RetrieveRequest.md) as the request type, and [`RetrieveResponse`](Serenity.Services/RetrieveResponse-1.md) as the response type. |
| class  | [RetrieveRequestHandlerAsync&lt;TRow,TRetrieveRequest,TRetrieveResponse&gt;](Serenity.Services/RetrieveRequestHandlerAsync-3.md) | Generic base class for asynchronous retrieve request handlers |
| abstract class  | [RetrieveRequestHandlerBase&lt;TRow,TRetrieveRequest,TRetrieveResponse&gt;](Serenity.Services/RetrieveRequestHandlerBase-3.md) | Abstract base class for retrieve request handlers that share state and mode neutral helper methods between synchronous and asynchronous retrieve request handlers. |
...
| class  | [SaveRequestHandlerAsync&lt;TRow&gt;](Serenity.Services/SaveRequestHandlerAsync-1.md) | Base generic class for async save request handlers that use [`SaveRequest`](Serenity.Services/SaveRequest-1.md) as the request type, and [`SaveResponse`](Serenity.Services/SaveResponse.md) as the response type. |
| class  | [SaveRequestHandlerAsync&lt;TRow,TSaveRequest,TSaveResponse&gt;](Serenity.Services/SaveRequestHandlerAsync-3.md) | Generic base class for asynchronous save request handlers |
| abstract class  | [SaveRequestHandlerBase&lt;TRow,TSaveRequest,TSaveResponse&gt;](Serenity.Services/SaveRequestHandlerBase-3.md) | Abstract base class for save request handlers that share state and mode neutral helper methods between synchronous and asynchronous save request handlers. |
...
| class  | [SyncToAsyncDeleteBehaviorWrapper](Serenity.Services/SyncToAsyncDeleteBehaviorWrapper.md) | Wraps an [`IDeleteBehaviorSync`](Serenity.Services/IDeleteBehaviorSync.md) implementation and exposes it as an [`IDeleteBehaviorAsync`](Serenity.Services/IDeleteBehaviorAsync.md). This allows asynchronous delete request handlers to run synchronous delete behaviors. |
| class  | [SyncToAsyncListBehaviorWrapper](Serenity.Services/SyncToAsyncListBehaviorWrapper.md) | Wraps an [`IListBehaviorSync`](Serenity.Services/IListBehaviorSync.md) implementation and exposes it as an [`IListBehaviorAsync`](Serenity.Services/IListBehaviorAsync.md). This allows asynchronous list request handlers to run synchronous list behaviors. |
| class  | [SyncToAsyncRetrieveBehaviorWrapper](Serenity.Services/SyncToAsyncRetrieveBehaviorWrapper.md) | Wraps an [`IRetrieveBehaviorSync`](Serenity.Services/IRetrieveBehaviorSync.md) implementation and exposes it as an [`IRetrieveBehaviorAsync`](Serenity.Services/IRetrieveBehaviorAsync.md). This allows asynchronous retrieve request handlers to run synchronous retrieve behaviors. |
| class  | [SyncToAsyncSaveBehaviorWrapper](Serenity.Services/SyncToAsyncSaveBehaviorWrapper.md) | Wraps an [`ISaveBehaviorSync`](Serenity.Services/ISaveBehaviorSync.md) implementation and exposes it as an [`ISaveBehaviorAsync`](Serenity.Services/ISaveBehaviorAsync.md). This allows asynchronous save request handlers to run synchronous save behaviors. |
| class  | [SyncToAsyncUndeleteBehaviorWrapper](Serenity.Services/SyncToAsyncUndeleteBehaviorWrapper.md) | Wraps an [`IUndeleteBehaviorSync`](Serenity.Services/IUndeleteBehaviorSync.md) implementation and exposes it as an [`IUndeleteBehaviorAsync`](Serenity.Services/IUndeleteBehaviorAsync.md). This allows asynchronous undelete request handlers to run synchronous undelete behaviors. |
...
| class  | [UndeleteRequestHandlerAsync&lt;TRow&gt;](Serenity.Services/UndeleteRequestHandlerAsync-1.md) | Base generic class for async undelete request handlers that use [`UndeleteRequest`](Serenity.Services/UndeleteRequest.md) as the request type, and [`UndeleteResponse`](Serenity.Services/UndeleteResponse.md) as the response type. |
| class  | [UndeleteRequestHandlerAsync&lt;TRow,TUndeleteRequest,TUndeleteResponse&gt;](Serenity.Services/UndeleteRequestHandlerAsync-3.md) | Generic base class for asynchronous undelete request handlers |
| abstract class  | [UndeleteRequestHandlerBase&lt;TRow,TUndeleteRequest,TUndeleteResponse&gt;](Serenity.Services/UndeleteRequestHandlerBase-3.md) | Abstract base class for undelete request handlers that share state and mode neutral helper methods between synchronous and asynchronous undelete request handlers. |
...
| class  | [ConcatenatedScript](Serenity.Web/ConcatenatedScript.md) | A dynamic script that is formed from the concatenation of other scripts. |
...
| interface  | [IUploadValidator](Serenity.Web/IUploadValidator.md) | An upload validator abstraction for checking IUploadFileConstraints and IUploadImageConstraints |
