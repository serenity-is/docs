...
| name | description |
| --- | --- |
| [ScaleBackColor](IUploadImageOptions/ScaleBackColor.md) { get; set; } | Background color to use when padding the image. |
...
| [ScaleSmaller](IUploadImageOptions/ScaleSmaller.md) { get; } | Should the image be scaled up to the requested size when it is smaller. |
...
* **Source:** *[IUploadImageOptions.cs](https://github.com/serenity-is/Serenity/blob/master/src/Core/ComponentModel/Upload/IUploadImageOptions.cs)*