[@serenity-is](../README.md) / [Modules](../modules.md) / [corelib](../modules/corelib.md) / EnumFiltering

# Class: EnumFiltering

[corelib](../modules/corelib.md).EnumFiltering

## Hierarchy

- [`BaseEditorFiltering`](corelib.BaseEditorFiltering.md)<[`EnumEditor`](corelib.EnumEditor.md)\>
...
- [constructor](corelib.EnumFiltering.md#constructor)

### Properties

- [editor](corelib.EnumFiltering.md#editor)
- [editorType](corelib.EnumFiltering.md#editortype)

### Methods

- [appendComparisonOperators](corelib.EnumFiltering.md#appendcomparisonoperators)
- [appendNullableOperators](corelib.EnumFiltering.md#appendnullableoperators)
- [argumentNull](corelib.EnumFiltering.md#argumentnull)
- [createEditor](corelib.EnumFiltering.md#createeditor)
- [displayText](corelib.EnumFiltering.md#displaytext)
- [getCriteria](corelib.EnumFiltering.md#getcriteria)
- [getCriteriaField](corelib.EnumFiltering.md#getcriteriafield)
- [getEditorOptions](corelib.EnumFiltering.md#geteditoroptions)
- [getEditorText](corelib.EnumFiltering.md#geteditortext)
- [getEditorValue](corelib.EnumFiltering.md#geteditorvalue)
- [getOperators](corelib.EnumFiltering.md#getoperators)
- [getTitle](corelib.EnumFiltering.md#gettitle)
- [get\_container](corelib.EnumFiltering.md#get_container)
- [get\_field](corelib.EnumFiltering.md#get_field)
- [get\_operator](corelib.EnumFiltering.md#get_operator)
- [initQuickFilter](corelib.EnumFiltering.md#initquickfilter)
- [isNullable](corelib.EnumFiltering.md#isnullable)
- [loadState](corelib.EnumFiltering.md#loadstate)
- [operatorFormat](corelib.EnumFiltering.md#operatorformat)
- [saveState](corelib.EnumFiltering.md#savestate)
- [set\_container](corelib.EnumFiltering.md#set_container)
- [set\_field](corelib.EnumFiltering.md#set_field)
- [set\_operator](corelib.EnumFiltering.md#set_operator)
- [useEditor](corelib.EnumFiltering.md#useeditor)
- [useIdField](corelib.EnumFiltering.md#useidfield)
- [validateEditorValue](corelib.EnumFiltering.md#validateeditorvalue)
...
[src/ui/filtering/filtering.ts:582](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filtering.ts#line&#x3D;582)

## Properties

### editor

• `Protected` **editor**: [`EnumEditor`](corelib.EnumEditor.md)
...
[src/ui/filtering/filtering.ts:586](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filtering.ts#line&#x3D;586)
