[@serenity-is/corelib](../README.md) / FilterFieldSelect

# Class: FilterFieldSelect\<P\>

Defined in: [src/ui/filtering/filterpanel.tsx:25](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L25)

A combobox that lets the user select a filter field.

## Extends

- [`ComboboxEditor`](ComboboxEditor.md)\<`P`, [`PropertyItem`](../interfaces/PropertyItem.md)\>

## Type Parameters

### P

`P` *extends* [`FilterFieldSelectOptions`](../interfaces/FilterFieldSelectOptions.md) = [`FilterFieldSelectOptions`](../interfaces/FilterFieldSelectOptions.md)
...
> **new FilterFieldSelect**\<`P`\>(`props`): `FilterFieldSelect`\<`P`\>

Defined in: [src/ui/filtering/filterpanel.tsx:32](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L32)
...
Defined in: [src/ui/filtering/filterpanel.tsx:26](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L26)
...
[`ComboboxItem`](../interfaces/ComboboxItem.md)\<[`PropertyItem`](../interfaces/PropertyItem.md)\>
...
> `protected` **asyncSearch**(`query`): `PromiseLike`\<[`ComboboxSearchResult`](../interfaces/ComboboxSearchResult.md)\<[`PropertyItem`](../interfaces/PropertyItem.md)\>\>
...
`PromiseLike`\<[`ComboboxSearchResult`](../interfaces/ComboboxSearchResult.md)\<[`PropertyItem`](../interfaces/PropertyItem.md)\>\>
...
> `protected` **cascadeItems**(`items`): [`PropertyItem`](../interfaces/PropertyItem.md)[]
...
Defined in: [src/ui/filtering/filterpanel.tsx:44](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L44)
...
> `protected` **filterItems**(`items`): [`PropertyItem`](../interfaces/PropertyItem.md)[]
...
> `protected` **get\_items**(): [`ComboboxItem`](../interfaces/ComboboxItem.md)\<[`PropertyItem`](../interfaces/PropertyItem.md)\>[]
...
Defined in: [src/ui/filtering/filterpanel.tsx:56](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterpanel.tsx#L56)
