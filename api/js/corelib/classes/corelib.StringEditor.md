[@serenity-is](../README.md) / [Modules](../modules.md) / [corelib](../modules/corelib.md) / StringEditor

# Class: StringEditor

[corelib](../modules/corelib.md).StringEditor
...
- [constructor](corelib.StringEditor.md#constructor)

### Properties

- [element](corelib.StringEditor.md#element)
- [idPrefix](corelib.StringEditor.md#idprefix)
- [options](corelib.StringEditor.md#options)
- [uniqueName](corelib.StringEditor.md#uniquename)
- [widgetName](corelib.StringEditor.md#widgetname)

### Accessors

- [value](corelib.StringEditor.md#value)

### Methods

- [addCssClass](corelib.StringEditor.md#addcssclass)
- [addValidationRule](corelib.StringEditor.md#addvalidationrule)
- [change](corelib.StringEditor.md#change)
- [changeSelect2](corelib.StringEditor.md#changeselect2)
- [destroy](corelib.StringEditor.md#destroy)
- [getCssClass](corelib.StringEditor.md#getcssclass)
- [getGridField](corelib.StringEditor.md#getgridfield)
- [get\_value](corelib.StringEditor.md#get_value)
- [init](corelib.StringEditor.md#init)
- [initialize](corelib.StringEditor.md#initialize)
- [renderContents](corelib.StringEditor.md#rendercontents)
- [set\_value](corelib.StringEditor.md#set_value)
- [create](corelib.StringEditor.md#create)
- [elementFor](corelib.StringEditor.md#elementfor)
- [getWidgetName](corelib.StringEditor.md#getwidgetname)
...
▸ **init**(`action?`): [`StringEditor`](corelib.StringEditor.md)
