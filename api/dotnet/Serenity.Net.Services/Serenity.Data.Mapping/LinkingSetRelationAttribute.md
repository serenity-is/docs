...
| name | description |
| --- | --- |
| [LinkingSetRelationAttribute](LinkingSetRelationAttribute/LinkingSetRelationAttribute.md)(…) | Specifies a linking set relation (1-N relation of ID values, like a check list.) |
