[@serenity-is/corelib](../README.md) / [Exports](../modules.md) / Select2Editor
...
- [constructor](Select2Editor.md#constructor)

### Properties

- [\_itemById](Select2Editor.md#_itembyid)
- [\_items](Select2Editor.md#_items)
- [cascadeLink](Select2Editor.md#cascadelink)
- [element](Select2Editor.md#element)
- [idPrefix](Select2Editor.md#idprefix)
- [initSelectionPromise](Select2Editor.md#initselectionpromise)
- [lastCreateTerm](Select2Editor.md#lastcreateterm)
- [onInitNewEntity](Select2Editor.md#oninitnewentity)
- [openDialogAsPanel](Select2Editor.md#opendialogaspanel)
- [options](Select2Editor.md#options)
- [queryPromise](Select2Editor.md#querypromise)
- [typeTimeout](Select2Editor.md#typetimeout)
- [uniqueName](Select2Editor.md#uniquename)
- [widgetName](Select2Editor.md#widgetname)

### Accessors

- [cascadeField](Select2Editor.md#cascadefield)
- [cascadeFrom](Select2Editor.md#cascadefrom)
- [cascadeValue](Select2Editor.md#cascadevalue)
- [filterField](Select2Editor.md#filterfield)
- [filterValue](Select2Editor.md#filtervalue)
- [itemById](Select2Editor.md#itembyid)
- [items](Select2Editor.md#items)
- [readOnly](Select2Editor.md#readonly)
- [selectedItem](Select2Editor.md#selecteditem)
- [selectedItems](Select2Editor.md#selecteditems)
- [text](Select2Editor.md#text)
- [value](Select2Editor.md#value)
- [values](Select2Editor.md#values)

### Methods

- [abortPendingQuery](Select2Editor.md#abortpendingquery)
- [addCssClass](Select2Editor.md#addcssclass)
- [addInplaceCreate](Select2Editor.md#addinplacecreate)
- [addItem](Select2Editor.md#additem)
- [addOption](Select2Editor.md#addoption)
- [addValidationRule](Select2Editor.md#addvalidationrule)
- [allowClear](Select2Editor.md#allowclear)
- [asyncSearch](Select2Editor.md#asyncsearch)
- [cascadeItems](Select2Editor.md#cascadeitems)
- [change](Select2Editor.md#change)
- [changeSelect2](Select2Editor.md#changeselect2)
- [clearItems](Select2Editor.md#clearitems)
- [createEditDialog](Select2Editor.md#createeditdialog)
- [destroy](Select2Editor.md#destroy)
- [editDialogDataChange](Select2Editor.md#editdialogdatachange)
- [emptyItemText](Select2Editor.md#emptyitemtext)
- [filterItems](Select2Editor.md#filteritems)
- [getCascadeFromValue](Select2Editor.md#getcascadefromvalue)
- [getCreateSearchChoice](Select2Editor.md#getcreatesearchchoice)
- [getCssClass](Select2Editor.md#getcssclass)
- [getDialogTypeKey](Select2Editor.md#getdialogtypekey)
- [getEditValue](Select2Editor.md#geteditvalue)
- [getGridField](Select2Editor.md#getgridfield)
- [getIdField](Select2Editor.md#getidfield)
- [getPageSize](Select2Editor.md#getpagesize)
- [getSelect2Options](Select2Editor.md#getselect2options)
- [getTextField](Select2Editor.md#gettextfield)
- [getTypeDelay](Select2Editor.md#gettypedelay)
- [get\_cascadeField](Select2Editor.md#get_cascadefield)
- [get\_cascadeFrom](Select2Editor.md#get_cascadefrom)
- [get\_cascadeValue](Select2Editor.md#get_cascadevalue)
- [get\_delimited](Select2Editor.md#get_delimited)
- [get\_filterField](Select2Editor.md#get_filterfield)
- [get\_filterValue](Select2Editor.md#get_filtervalue)
- [get\_itemByKey](Select2Editor.md#get_itembykey)
- [get\_items](Select2Editor.md#get_items)
- [get\_readOnly](Select2Editor.md#get_readonly)
- [get\_select2Container](Select2Editor.md#get_select2container)
- [get\_text](Select2Editor.md#get_text)
- [get\_value](Select2Editor.md#get_value)
- [get\_values](Select2Editor.md#get_values)
- [hasAsyncSource](Select2Editor.md#hasasyncsource)
- [init](Select2Editor.md#init)
- [initNewEntity](Select2Editor.md#initnewentity)
- [initialize](Select2Editor.md#initialize)
- [inplaceCreateClick](Select2Editor.md#inplacecreateclick)
- [isAutoComplete](Select2Editor.md#isautocomplete)
- [isMultiple](Select2Editor.md#ismultiple)
- [itemDisabled](Select2Editor.md#itemdisabled)
- [itemId](Select2Editor.md#itemid)
- [itemText](Select2Editor.md#itemtext)
- [mapItem](Select2Editor.md#mapitem)
- [mapItems](Select2Editor.md#mapitems)
- [renderContents](Select2Editor.md#rendercontents)
- [setCascadeFrom](Select2Editor.md#setcascadefrom)
- [setEditDialogReadOnly](Select2Editor.md#seteditdialogreadonly)
- [setEditValue](Select2Editor.md#seteditvalue)
- [setTermOnNewEntity](Select2Editor.md#settermonnewentity)
- [set\_cascadeField](Select2Editor.md#set_cascadefield)
- [set\_cascadeFrom](Select2Editor.md#set_cascadefrom)
- [set\_cascadeValue](Select2Editor.md#set_cascadevalue)
- [set\_filterField](Select2Editor.md#set_filterfield)
- [set\_filterValue](Select2Editor.md#set_filtervalue)
- [set\_readOnly](Select2Editor.md#set_readonly)
- [set\_value](Select2Editor.md#set_value)
- [set\_values](Select2Editor.md#set_values)
- [updateInplaceReadOnly](Select2Editor.md#updateinplacereadonly)
- [updateItems](Select2Editor.md#updateitems)
- [useInplaceAdd](Select2Editor.md#useinplaceadd)
- [create](Select2Editor.md#create)
- [elementFor](Select2Editor.md#elementfor)
- [filterByText](Select2Editor.md#filterbytext)
- [getWidgetName](Select2Editor.md#getwidgetname)
...
• `Private` **initSelectionPromise**: [`Select2SearchPromise`](../interfaces/Select2SearchPromise.md)
...
• `Private` **queryPromise**: [`Select2SearchPromise`](../interfaces/Select2SearchPromise.md)
...
▸ **init**(`action?`): [`Select2Editor`](Select2Editor.md)<`TOptions`, `TItem`\>
