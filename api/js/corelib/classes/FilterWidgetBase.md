...
Defined in: [src/ui/filtering/filterwidgetbase.ts:9](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterwidgetbase.ts#L9)

Base widget that owns a [FilterStore](FilterStore.md) and reacts to its changes.
...
> **new FilterWidgetBase**\<`P`\>(`props`): `FilterWidgetBase`\<`P`\>
...
Defined in: [src/ui/filtering/filterwidgetbase.ts:10](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterwidgetbase.ts#L10)
...
Defined in: [src/ui/filtering/filterwidgetbase.ts:45](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/filtering/filterwidgetbase.ts#L45)
