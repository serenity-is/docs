[@serenity-is/corelib](../README.md) / [Exports](../modules.md) / EmailEditor

# Class: EmailEditor

## Hierarchy

- [`Widget`](Widget.md)<[`EmailEditorOptions`](../interfaces/EmailEditorOptions.md)\>
...
- [widgetName](EmailEditor.md#widgetname)
...
- [initialize](EmailEditor.md#initialize)
...
- [elementFor](EmailEditor.md#elementfor)
...
| :------ | :------ |
| `input` | `JQuery` |
| `opt` | [`EmailEditorOptions`](../interfaces/EmailEditorOptions.md) |
...
• `Protected` **options**: [`EmailEditorOptions`](../interfaces/EmailEditorOptions.md)
...
[src/ui/editors/emaileditor.ts:95](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/emaileditor.ts#L95)
...
[src/ui/editors/emaileditor.ts:132](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/emaileditor.ts#L132)
...
[src/ui/editors/emaileditor.ts:82](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/emaileditor.ts#L82)

___

### init

▸ **init**(`action?`): [`EmailEditor`](EmailEditor.md)
...
[src/ui/editors/emaileditor.ts:138](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/emaileditor.ts#L138)
...
[src/ui/editors/emaileditor.ts:99](https://github.com/serenity-is/serenity/blob/master/packages/corelib/src/ui/editors/emaileditor.ts#L99)
