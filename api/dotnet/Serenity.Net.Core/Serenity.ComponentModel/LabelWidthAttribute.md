...
| [UntilNext](LabelWidthAttribute/UntilNext.md) { get; set; } | Gets or sets a value indicating whether this attribute should apply to following properties until next occurrence of this attribute without JustThis flag. |
| [Value](LabelWidthAttribute/Value.md) { get; } | Gets the value. |

## See Also

* **Source:** *[LabelWidthAttribute.cs](https://github.com/serenity-is/Serenity/blob/a5013fdf777dbbd87589205ddffcb67f18bea673/src/core/ComponentModel/PropertyGrid/Layout/LabelWidthAttribute.cs)*