[@serenity-is/corelib](../README.md) / [Exports](../modules.md) / PopupMenuButton

# Class: PopupMenuButton

## Hierarchy

- [`Widget`](Widget.md)<[`PopupMenuButtonOptions`](../interfaces/PopupMenuButtonOptions.md)\>
...
- [constructor](PopupMenuButton.md#constructor)

### Properties

- [element](PopupMenuButton.md#element)
- [idPrefix](PopupMenuButton.md#idprefix)
- [options](PopupMenuButton.md#options)
- [uniqueName](PopupMenuButton.md#uniquename)
- [widgetName](PopupMenuButton.md#widgetname)

### Methods

- [addCssClass](PopupMenuButton.md#addcssclass)
- [addValidationRule](PopupMenuButton.md#addvalidationrule)
- [change](PopupMenuButton.md#change)
- [changeSelect2](PopupMenuButton.md#changeselect2)
- [destroy](PopupMenuButton.md#destroy)
- [getCssClass](PopupMenuButton.md#getcssclass)
- [getGridField](PopupMenuButton.md#getgridfield)
- [init](PopupMenuButton.md#init)
- [initialize](PopupMenuButton.md#initialize)
- [renderContents](PopupMenuButton.md#rendercontents)
- [create](PopupMenuButton.md#create)
- [elementFor](PopupMenuButton.md#elementfor)
- [getWidgetName](PopupMenuButton.md#getwidgetname)
...
| :------ | :------ |
| `div` | `JQuery` |
| `opt` | [`PopupMenuButtonOptions`](../interfaces/PopupMenuButtonOptions.md) |
...
▸ **init**(`action?`): [`PopupMenuButton`](PopupMenuButton.md)
